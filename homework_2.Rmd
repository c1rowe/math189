...
#setup
getwd()
setwd("/Users/Me/Documents/Datascience/Rowe/UFOs")
...
plot(density(dat$year[index1]), main="Year Density, before 1970", xlab="Year Sighted")
plot(density(dat$year[index2]), main="Year Density, 1971 - 1990", xlab="Year Sighted")
plot(density(dat$year[index3]), main="Year Density, after 1991", xlab="Year Sighted")
